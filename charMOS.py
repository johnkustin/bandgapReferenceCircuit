...
def genNetlistNngspice(fName='charNMOS.net'):
    ...
    netlistN.write("save all @m.xn.msky130_fd_pr__nfet_01v8[id] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[vth]\n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[gm]\n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[gmbs] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[gds] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[cgg] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[cgs] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[cgd] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[cdd] \n")
    netlistN.write("+ @m.xn.msky130_fd_pr__nfet_01v8[cbs] \n")
    netlistN.write("\n")
    netlistN.write("dc vgs 0 {0} {1} vds 0 {2} {3}\n".format(vgsMax, vgsStep, vdsMax, vdsStep))
    netlistN.write("\n")
    netlistN.write("let id   = @m.xn.msky130_fd_pr__nfet_01v8[id]\n")
    netlistN.write("let vt   = @m.xn.msky130_fd_pr__nfet_01v8[vth]\n")
    netlistN.write("let gm   = @m.xn.msky130_fd_pr__nfet_01v8[gm]\n")
    netlistN.write("let gmb  = @m.xn.msky130_fd_pr__nfet_01v8[gmbs]\n")
    netlistN.write("let gds  = @m.xn.msky130_fd_pr__nfet_01v8[gds]\n")
    netlistN.write("let cgg  = @m.xn.msky130_fd_pr__nfet_01v8[cgg]\n")
    netlistN.write("let cgs  = -@m.xn.msky130_fd_pr__nfet_01v8[cgs]\n")
    netlistN.write("let cgd  = -@m.xn.msky130_fd_pr__nfet_01v8[cgd]\n")
    netlistN.write("let cgb  = @m.xn.msky130_fd_pr__nfet_01v8[cgg] - (-@m.xn.msky130_fd_pr__nfet_01v8[cgs])-(-@m.xn.msky130_fd_pr__nfet_01v8[cgd])\n")
    netlistN.write("let cdd  = @m.xn.msky130_fd_pr__nfet_01v8[cdd]\n")
    netlistN.write("let css  = -@m.xn.msky130_fd_pr__nfet_01v8[cgs]-@m.xn.msky130_fd_pr__nfet_01v8[cbs]\n")
...
def genNetlistPngspice(fName='charPMOS.net'):
    ...
    netlistP.write("save all @m.xp.msky130_fd_pr__pfet_01v8_hvt[id] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[vth]\n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[gm]\n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[gmbs] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[gds] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[cgg] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[cgs] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[cgd] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[cdd] \n")
    netlistP.write("+ @m.xp.msky130_fd_pr__pfet_01v8_hvt[cbs] \n")
    netlistP.write("\n")
    netlistP.write("dc vgs 0 {0} {1} vds 0 {2} {3}\n".format(-vgsMax, -vgsStep, -vdsMax, -vdsStep))
    netlistP.write("\n")
    netlistP.write("let id   = @m.xp.msky130_fd_pr__pfet_01v8_hvt[id]\n")
    netlistP.write("let vt   = @m.xp.msky130_fd_pr__pfet_01v8_hvt[vth]\n")
    netlistP.write("let gm   = @m.xp.msky130_fd_pr__pfet_01v8_hvt[gm]\n")
    netlistP.write("let gmb  = @m.xp.msky130_fd_pr__pfet_01v8_hvt[gmbs]\n")
    netlistP.write("let gds  = @m.xp.msky130_fd_pr__pfet_01v8_hvt[gds]\n")
    netlistP.write("let cgg  = @m.xp.msky130_fd_pr__pfet_01v8_hvt[cgg]\n")
    netlistP.write("let cgs  = -@m.xp.msky130_fd_pr__pfet_01v8_hvt[cgs]\n")
    netlistP.write("let cgd  = -@m.xp.msky130_fd_pr__pfet_01v8_hvt[cgd]\n")
    netlistP.write("let cgb  = @m.xp.msky130_fd_pr__pfet_01v8_hvt[cgg] - (-@m.xp.msky130_fd_pr__pfet_01v8_hvt[cgs])-(-@m.xp.msky130_fd_pr__pfet_01v8_hvt[cgd])\n")
    netlistP.write("let cdd  = @m.xp.msky130_fd_pr__pfet_01v8_hvt[cdd]\n")
    netlistP.write("let css  = -@m.xp.msky130_fd_pr__pfet_01v8_hvt[cgs]-@m.xp.msky130_fd_pr__pfet_01v8_hvt[cbs]\n")
    netlistP.write("\n")
